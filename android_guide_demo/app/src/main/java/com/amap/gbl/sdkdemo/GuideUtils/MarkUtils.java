...
public class MarkUtils {
    ...
    public static void createRouteMarker(Context context, GLMapView mapView) {
        ...
        //车标、起终点走鹰眼图的适配
        addOverlayTexture(context,mapView, MARKER_ID_CAR, R.drawable.car);
        addOverlayTexture(context,mapView, MARKER_ID_BUBBLE_START, R.drawable.trace_bubble_start);
        addOverlayTexture(context,mapView, MARKER_ID_BUBBLE_END, R.drawable.trace_bubble_end);
    ...
    private static void createMakerByText(Context context, GLMapView mapView, String text, int bgResId, int id, int engineId) {
        ...
        textView.setBackgroundColor(context.getResources().getColor(R.color.color_f36472));
        if (bgResId != 0) {
        ...
        try {
            ...
            Logger.E("createMakerByText" + text, e);
