    ...
    public RoadParam getRoadParam(int textureType, boolean isOffline, boolean isAlternative, boolean isHighLight) {
        ...
        switch (textureType) {
            ...
            case MapRouteTexture.MapRouteTextureNavi:
                ...
                fillLineColor = MyApplication.getAppContext().getResources().getColor(R.color.color_ff0096ff);
                borderColor = MyApplication.getAppContext().getResources().getColor(R.color.color_ff0096ff);
            ...
            case MapRouteTexture.MapRouteTextureNonavi:
                ...
                fillLineColor = MyApplication.getAppContext().getResources().getColor(R.color.color_ffffff_ff);
                borderColor = MyApplication.getAppContext().getResources().getColor(R.color.color_ffffff_ff);
